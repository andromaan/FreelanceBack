    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_freelancer_language", x => new { x.freelancer_id, x.languages_id });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("11111111-1111-1111-1111-111111111111"), null, new DateTime(2026, 1, 17, 11, 18, 37, 491, DateTimeKind.Utc).AddTicks(2874), new Guid("11111111-1111-1111-1111-111111111111"), "Admin", "admin@mail.com", null, null, new DateTime(2026, 1, 17, 11, 18, 37, 491, DateTimeKind.Utc).AddTicks(2881), new Guid("11111111-1111-1111-1111-111111111111"), "73B6E34C220F5D20A3F234085E9C17FECC825DE9356BCC6EA82676B5C9E32822-06FEDFB61DC414A30E0FE7E57985F531", "admin" });
