...
namespace DAL.Migrations
{
    ...
    [Migration("20260117111837_Initial")]
            ...
            modelBuilder.Entity("Domain.Models.Auth.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 17, 11, 18, 37, 491, DateTimeKind.Utc).AddTicks(2874),
                            CreatedBy = new Guid("11111111-1111-1111-1111-111111111111"),
                            DisplayName = "Admin",
                            Email = "admin@mail.com",
                            ModifiedAt = new DateTime(2026, 1, 17, 11, 18, 37, 491, DateTimeKind.Utc).AddTicks(2881),
                            ModifiedBy = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "73B6E34C220F5D20A3F234085E9C17FECC825DE9356BCC6EA82676B5C9E32822-06FEDFB61DC414A30E0FE7E57985F531",
                            RoleId = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Models.Freelance.Job", b =>
                {
                    ...
                    b.HasIndex("EmployerId")
                        .HasDatabaseName("ix_jobs_employer_id");
            ...
            modelBuilder.Entity("Domain.Models.Freelance.Job", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Employers.Employer", "Client")
                        .WithMany()
                        .HasForeignKey("EmployerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
