...
namespace DAL.Migrations
{
    ...
    [Migration("20260210153408_AddDisputeEntity")]
            ...
            modelBuilder.Entity("Domain.Models.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 10, 15, 34, 8, 295, DateTimeKind.Utc).AddTicks(9820),
                            CreatedBy = new Guid("11111111-1111-1111-1111-111111111111"),
                            DisplayName = "Admin",
                            Email = "admin@mail.com",
                            ModifiedAt = new DateTime(2026, 2, 10, 15, 34, 8, 295, DateTimeKind.Utc).AddTicks(9836),
                            ModifiedBy = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "0C2575F8D923100A8FD76ED38BC79C79DE118C60E5229CDD7D85BF882D1BD369-42864329913A9846E32B44EE6BF5FC74",
                            RoleId = "admin"
                        });
                });
