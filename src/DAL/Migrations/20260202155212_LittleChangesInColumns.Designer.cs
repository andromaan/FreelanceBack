...
namespace DAL.Migrations
{
    ...
    [Migration("20260202155212_LittleChangesInColumns")]
    partial class LittleChangesInColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.Auth.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 2, 2, 15, 52, 12, 376, DateTimeKind.Utc).AddTicks(9582),
                            CreatedBy = new Guid("11111111-1111-1111-1111-111111111111"),
                            DisplayName = "Admin",
                            Email = "admin@mail.com",
                            ModifiedAt = new DateTime(2026, 2, 2, 15, 52, 12, 376, DateTimeKind.Utc).AddTicks(9589),
                            ModifiedBy = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "769C4C0D4C9C5517F895B075F3209FCDF28297C9AA2A3CB884294946361A3A4C-921F4AF4A871E6C9402322210A948815",
                            RoleId = "admin"
                        });
                });
