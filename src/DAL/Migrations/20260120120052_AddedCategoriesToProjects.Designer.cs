...
namespace DAL.Migrations
{
    ...
    [Migration("20260120120052_AddedCategoriesToProjects")]
    partial class AddedCategoriesToProjects
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryProject", b =>
                {
                    ...
                    b.HasKey("CategoriesId", "ProjectId")
                        .HasName("pk_category_project");

                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_category_project_project_id");

                    b.ToTable("category_project", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.Auth.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 1, 20, 12, 0, 51, 958, DateTimeKind.Utc).AddTicks(3577),
                            CreatedBy = new Guid("11111111-1111-1111-1111-111111111111"),
                            DisplayName = "Admin",
                            Email = "admin@mail.com",
                            ModifiedAt = new DateTime(2026, 1, 20, 12, 0, 51, 958, DateTimeKind.Utc).AddTicks(3586),
                            ModifiedBy = new Guid("11111111-1111-1111-1111-111111111111"),
                            PasswordHash = "648F71DB31C58420563B6F1022799EACEC677B0767FE2DDC8093D23E55AD5C82-62FEA1406A384136AB2560C3E60A767B",
                            RoleId = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Models.Freelance.Contract", b =>
                {
                    ...
                    b.HasIndex("EmployerId")
                        .HasDatabaseName("ix_contracts_employer_id");
            ...
            modelBuilder.Entity("Domain.Models.Freelance.FreelancerSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("FreelancerId")
                        .HasDatabaseName("ix_freelancers_skills_freelancer_id");

                    b.HasIndex("SkillId")
                        .HasDatabaseName("ix_freelancers_skills_skill_id");
            ...
            modelBuilder.Entity("FreelancerLanguage", b =>
                {
                    ...
                    b.HasKey("FreelancerId", "LanguagesId")
                        .HasName("pk_freelancer_language");

                    b.HasIndex("LanguagesId")
                        .HasDatabaseName("ix_freelancer_language_languages_id");

                    b.ToTable("freelancer_language", (string)null);
                });
            ...
            modelBuilder.Entity("CategoryProject", b =>
                {
                    b.HasOne("Domain.Models.Projects.Category", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_category_project_categories_categories_id");
                    ...
                    b.HasOne("Domain.Models.Projects.Project", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_category_project_projects_project_id");
                });
            ...
            modelBuilder.Entity("Domain.Models.Freelance.Contract", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Employers.Employer", "Employer")
                        .WithMany()
                        .HasForeignKey("EmployerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_contracts_employers_employer_id");
            ...
            modelBuilder.Entity("Domain.Models.Freelance.FreelancerSkill", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Projects.Skill", "Skill")
                        .WithMany()
                        .HasForeignKey("SkillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_freelancers_skills_skill_skill_id");
            ...
            modelBuilder.Entity("Domain.Models.Freelance.Proposal", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Projects.Project", "Project")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_proposals_project_project_id");
            ...
            modelBuilder.Entity("FreelancerLanguage", b =>
                {
                    b.HasOne("Domain.Models.Freelance.Freelancer", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_freelancer_language_freelancers_freelancer_id");
                    ...
                    b.HasOne("Domain.Models.Languages.Language", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_freelancer_language_language_languages_id");
                });
